      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg shadow">
          <div className="p-6 border-b flex justify-between items-center">
            ...
            <Link href="/tutor/availability" className="text-indigo-600 text-sm hover:text-indigo-800">
              Set Availability →
            </Link>
          </div>
          <div className="p-6">
            {upcomingBookings.length === 0 ? (
              <div className="text-center py-8">
                ...
                <Link href="/tutor/availability" className="text-indigo-600 text-sm mt-2 inline-block">
            ...
            >
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600">Set your teaching schedule</p>
                </div>
              </div>
              ...
              <div key={booking.id} className="p-6 flex justify-between items-center hover:bg-gray-50 transition">
                ...
                <div className="text-right">
                  ...
                  {booking.review ? (
                    ...
                    <p className="text-sm text-gray-500 mt-1">No review yet</p>
                  )}
                </div>
              </div>
            ))}

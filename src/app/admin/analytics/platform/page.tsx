    ...
    <div>
      ...
      <div className="mb-8">
        <div className="flex justify-between items-center">
          <div>
            ...
            <p className="text-gray-600 mt-1">View platform performance metrics and insights</p>
          </div>
          <Link
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-emerald-600">{getTotalCompletedBookings()}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-purple-600">{getNewUsers()}</p>
            </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-2xl font-bold text-amber-600">{getCompletionRate()}%</p>
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          {getSubjectPieData().length === 0 && (
            <div className="text-center text-gray-500 mt-4">No subject data available</div>
          )}
        </div>
      </div>
        ...
        <div className="p-6 border-b">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-gray-500 mt-1">Highest rated tutors on the platform</p>
            </div>
                ...
                analytics.topTutors.map((tutor, index) => (
                  <tr key={tutor.id} className="hover:bg-gray-50 transition">
                    <td className="px-6 py-4">
                      <div className={`text-2xl font-bold ${index === 0 ? 'text-yellow-500' : index === 1 ? 'text-gray-400' : index === 2 ? 'text-amber-600' : 'text-gray-400'}`}>
                        #{index + 1}
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          <p className="font-medium text-gray-900">{tutor.user?.name || 'Unknown'}</p>
                          <p className="text-sm text-gray-500">{tutor.title || 'No title'}</p>
                        </div>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                    ...
                    <td className="px-6 py-4">
                      <div className="flex items-center gap-1">
                        ...
                        <span className="text-sm text-gray-500">({tutor.totalreviews || 0})</span>
                      </div>
                    </td>
                    <td className="px-6 py-4">
                      <span className="font-medium text-green-600">${tutor.hourlyrate || 0}/hr</span>
                    </td>
      ...
      {(!analytics?.bookingTrends || analytics.bookingTrends.length === 0) && (
        <div className="mt-8 bg-yellow-50 border border-yellow-200 rounded-lg p-6 text-center">
          <p className="text-yellow-800">No data available for the selected date range. Try a different range or check your database.</p>
        </div>
      )}
    </div>
  );
